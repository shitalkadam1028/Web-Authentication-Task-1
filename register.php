    ...
    if(isset($_POST['register']))
{
    ...
    if($password == $cpassword){
        $sql="INSERT INTO `reg`(`email`, `password`, `fname`, `lname`, `gender`, `country`) VALUES ('$email','$password','$fname','$lname','$gender','$country')";
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <h5 class="card-title mb-3">
                            <b> Responsive Registration <br> Form </b>
                        </h5>
                        <form action="register.php" class="" method="post">
                            ...
                            <button type="submit"name="register" class="btn btn-warning mt-3 btnSize">
                                Register
                            </button>
                        </form>
                    </div>
